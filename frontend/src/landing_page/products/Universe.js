          ...
          <div className='row text-center'> 
           ...
           <p>
            ...
            <p className='text-small text-muted'>Thematic investment platform</p>
                ...
                <div className='col-4  p-3'>   
            <img src="media/images/streakLogo.png" style={{height: "40px", width: "120px"}} />  
            ...
            <img src="media/images/zerodhaFundhouse.png" style={{height: "50px", width: "150px"}} /> 
            ...
            <p className='text-small text-muted'>Bonds trading platform</p> 
                ...
                <div className='col-4 p-3 mt-5'>     
            <img src="media/images/dittoLogo.png" style={{height: "40px", width: "120px"}} />   
