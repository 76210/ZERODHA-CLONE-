...
function ProductsPage() { 
    return ( 
       ...
       productName="Kite"
        ...
        advanced charts, an elegant UI, and more. Enjoy the Kite exprience seamlessly on your
       ...
       productName="Console"
        productDescription="The central dashboard for your Zerodha account Gain
        insight into your trades and investments with in-depth 
        reports and visulations." 
         learnMore="" 
         />
     ...
     <LeftSection imageURL="media/images/varsity.png" 
       productName="Varsity mobile" 
        ...
        coverage and illustrations. Content is broken down into bit-size cards to help you learn on 
        the go."
         tryDemo="" 
         learnMore=""
          googlePlay=""
           appStore=""/> 
       <p className="text-center">Want to know more about our technology stack? Check out the Zerodha. tech
        blog.</p>
       <Universe/> 
       </> 
     );
